...
void text_menu(game_t *gm)
{
    ...
    sfText_setCharacterSize(gm->menu->t_b_menu->play, 1);
    ...
    sfText_setPosition(gm->title->title1, (sfVector2f){900, 200});
    sfText_setPosition(gm->title->title2, (sfVector2f){1200, 290});
